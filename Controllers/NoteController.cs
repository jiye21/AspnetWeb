...
namespace AspnetWeb.Controllers
{
	public class NoteController : Controller
	{
		...
		/// <returns></returns>
		[HttpPost]
		[Route("/api/Note/UpdateHeartCount")]
		...
		/// <returns></returns>
		[HttpGet("/api/Note/SearchFriendWithName/{name}")]
		...
		[HttpGet("/api/Note/AddFriend/{muid}")]
		...
		[HttpGet("/api/Note/DeleteFriend/{friendMUID}")]
